...
(defprotocol MethodCombination
  ...
  (combine-methods
    [method-combination primary-methods aux-methods]
  ...
  (transform-fn-tail
    [method-combination qualifier fn-tail]
...
(defprotocol Dispatcher
  ...
  (^methodical.interface.Dispatcher ^{:style/indent :defn} with-prefers
    [dispatcher new-prefs]
    "Return a copy of `dispatcher` with its preferences map replaced with `new-prefs`.")

  (dominates?
    [dispatcher dispatch-val-x dispatch-val-y]
...
(defprotocol MultiFnImpl
  ...
  (^methodical.interface.MethodCombination method-combination
    [multifn]
  ...
  (^methodical.interface.MultiFnImpl ^{:style/indent :defn} with-dispatcher
    [multifn new-dispatcher]
    "Return a copy of this multifn using `new-dispatcher` as its dispatcher.")

  (^methodical.interface.MethodTable method-table
    [multifn]
    "Get the method table associated with this multifn.")

  (^methodical.interface.MultiFnImpl ^{:style/indent :defn} with-method-table
    [multifn new-method-table]
...
(defprotocol Cache
  ...
  (^methodical.interface.Cache empty-copy
    [cache]
