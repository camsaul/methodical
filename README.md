...
Code, documentation, and artwork copyright © 2019-2020 [Cam Saul](https://camsaul.com).

Distributed under the [Eclipse Public
License](https://raw.githubusercontent.com/camsaul/methodical/master/LICENSE), same as Clojure.
